...
This file focuses on simple or primitive data types such as numbers,
strings, booleans and None.  It introduces variables, data type
casting, basic arithmetic and logical operations, conditional
statements and loops using numeric and string sequences.  Each code
example is wrapped in a triple quoted string using single quotes; remove
the quotes to execute the example.

1. Variables and values – creating and assigning variables.
2. Simple data types – strings, integers, floats, complex numbers,
   booleans and None.
3. Operators – arithmetic, comparison, logical and swapping values.
4. Conditional statements – if, elif and else.
5. Loops – for and while loops with numbers and strings, including
   range-based counting, break/continue, else clauses, and a
   challenge to find divisible numbers.
